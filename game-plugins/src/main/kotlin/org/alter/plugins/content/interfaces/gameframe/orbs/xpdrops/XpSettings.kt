...
object XpSettings {
    ...
    fun open(p: Player) {
        ...
        p.setInterfaceEvents(interfaceId = 137, component = 59, 1..2, InterfaceEvent.ClickOp1)
        p.setInterfaceEvents(interfaceId = 137, component = 58, 1..3, InterfaceEvent.ClickOp1)
        p.setInterfaceEvents(interfaceId = 137, component = 57, 1..2, InterfaceEvent.ClickOp1)
        p.setInterfaceEvents(interfaceId = 137, component = 56, 1..8, InterfaceEvent.ClickOp1)
        p.setInterfaceEvents(interfaceId = 137, component = 51, 1..3, InterfaceEvent.ClickOp1)
        p.setInterfaceEvents(interfaceId = 137, component = 17, 0..24, InterfaceEvent.ClickOp1)
        p.setInterfaceEvents(interfaceId = 137, component = 55, 1..32, InterfaceEvent.ClickOp1)
