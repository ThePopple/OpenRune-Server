...
class DragonWarhammerPlugin(
    ...
    init {
        ...
        SpecialAttacks.register("items.dragon_warhammer", SPECIAL_REQUIREMENT) {
            player.animate(id = "sequences.warhammer_special")
            player.graphic(id = "spotanims.sp_attack_warhammer_spotanim", height = 92)
