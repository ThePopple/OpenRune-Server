...
private fun getVarTypeImplClass(varType: VarType): ClassName {
    return ClassName(VAR_TYPES_PACKAGE, when (varType) {
        ...
        VarType.COMPONENT -> "ComponentVarType"
        VarType.INV -> "InvVarType"
        VarType.IDKIT -> "IdkVarType"
        VarType.ENUM -> "EnumVarType"
        VarType.MIDI -> "MidiType"
        VarType.VARP -> "VarpVarType"
